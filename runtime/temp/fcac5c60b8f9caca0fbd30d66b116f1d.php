<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:69:"C:\Thankphp\Thinkphp\public/../application/admin\view\entry\pass.html";i:1511237115;s:63:"C:\Thankphp\Thinkphp\public/../application/admin\view\base.html";i:1511313729;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <!-- required -->
                    <input type="password" name="password" class="form-control" placeholder="请填写原始密码">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <!-- required -->
                    <input type="password" name="new_password" class="form-control" placeholder="请填写新密码">
                </div>
            </div>
            <div class="form-group">
