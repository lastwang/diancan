<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:73:"C:\Thankphp\Thinkphp\public/../application/admin\view\category\index.html";i:1511672654;s:63:"C:\Thankphp\Thinkphp\public/../application/admin\view\base.html";i:1511665508;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    ...
    function del(cate_id) {
        require(['hdjs'], function(hdjs) {
            hdjs.confirm('确定删除吗?', function() {
                // alert('点击确定后执行的回调函数');
                location.href = "<?php echo url('del'); ?>";
                alert(location.href);
            })
        })
    }
