<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:69:"C:\Thankphp\Thinkphp\public/../application/admin\view\link\store.html";i:1515654532;s:63:"C:\Thankphp\Thinkphp\public/../application/admin\view\base.html";i:1515568564;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<ol class="breadcrumb" style="background-color: #f9f9f9;padding:8px 0;margin-bottom:10px;">
    ...
    <?php if(input('param.linkId')==null): ?>
    <li class="active">
        <a href="<?php echo url('store'); ?>">添加友链</a>
    </li>
    <?php else: ?>
    <li class="active">
        <a href="<?php echo url('store'); ?>">编辑友链</a>
    </li>
    <?php endif; ?>
</ol>
<ul class="nav nav-tabs" role="tablist">
    ...
    <?php if(input('param.linkId')==null): ?>
    <li class="active"><a href="<?php echo url('store'); ?>">添加友链</a></li>
    <?php else: ?>
    <li class="active"><a href="<?php echo url('store'); ?>">编辑友链</a></li>
    <?php endif; ?>
</ul>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" name="linkName" class="form-control" value="<?php echo $oldData[ 'linkName']; ?>" placeholder="请填写友链名称">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="url" name="linkUrl" class="form-control" value="<?php echo $oldData[ 'linkUrl']; ?>" placeholder="请输入url地址">
                </div>
            </div>
            <div class="form-group">
                <label for="" class="col-sm-2 control-label">排序</label>
                <div class="col-sm-9">
                    <!-- <input type="number" name="linkSort" class="form-control"  value="<?php echo $oldData['linkSort']; ?>"  value="100"  placeholder=""> -->
                    <input type="number" name="linkSort" class="form-control" value="<?php echo $oldData['linkSort']; ?>" placeholder="">
                </div>
            </div>
        </div>
    </div>
    <input type="hidden" name="linkId" value="<?php echo input('param.linkId'); ?>">
