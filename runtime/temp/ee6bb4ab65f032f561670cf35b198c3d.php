<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"C:\Thankphp\Thinkphp\public/../application/admin\view\category\edit.html";i:1511660218;s:63:"C:\Thankphp\Thinkphp\public/../application/admin\view\base.html";i:1522568921;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" name="name" value="<?php echo $oldData['name']; ?>" class="form-control" placeholder="">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <select class="js-example-basic-single form-control" name="pid">
                        ...
                        <option <?php if($oldData['pid']==$vo['id']): ?>selected<?php endif; ?> value="<?php echo ++$key; ?>"><?php echo $vo['_name']; ?></option>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="number" name="sort" value="<?php echo $oldData['sort']; ?>" class="form-control" placeholder="">
                </div>
            </div>
        </div>
    </div>
    <input type="hidden" name='id' value="<?php echo input('param.cateid'); ?>">
