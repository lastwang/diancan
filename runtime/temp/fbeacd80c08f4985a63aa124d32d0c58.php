<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:68:"C:\Thankphp\Thinkphp\public/../application/admin\view\tag\store.html";i:1512397084;s:63:"C:\Thankphp\Thinkphp\public/../application/admin\view\base.html";i:1520758063;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" placeholder="标签名称" name="tagname" value="<?php echo $oldDate['tagname']; ?>">
                </div>
            </div>
        </div>
    </div>
