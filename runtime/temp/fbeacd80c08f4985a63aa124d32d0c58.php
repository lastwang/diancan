<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:68:"C:\Thankphp\Thinkphp\public/../application/admin\view\tag\store.html";i:1523330026;s:63:"C:\Thankphp\Thinkphp\public/../application/admin\view\base.html";i:1523330283;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<ul class="nav nav-tabs" role="tablist">
    <li><a href="<?php echo url('admin/tag/index'); ?>">菜风格列表</a></li>
    <?php if(input('param.tagid')!=null): ?>
    <li class="active">
        <a href="">编辑菜风格</a>
    </li>
...
<form class="form-horizontal" id="form" action="" method="post">
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title">菜风格列表</h3>
        </div>
        <div class="panel-body">
            <div class="form-group">
                <label for="" class="col-sm-2 control-label">菜风格名称</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control" placeholder="菜风格名称" name="tagname" value="<?php echo $oldDate['tagname']; ?>">
                </div>
            </div>
        </div>
    </div>
    <input type="hidden" name="tagid" value="<?php echo input('param.tagid'); ?>">
