<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:67:"C:\Thankphp\Thinkphp\public/../application/admin\view\tag\edit.html";i:1512390274;s:63:"C:\Thankphp\Thinkphp\public/../application/admin\view\base.html";i:1512370316;}*/ ?>
<!DOCTYPE html>
<html lang="en">
        ...
        function del(cate_id) {
            require(['hdjs'], function(hdjs) {
                hdjs.confirm('确定删除吗?', function() {
                    // alert('点击确定后执行的回调函数');
                    window.location.href = "<?php echo url('admin/Category/del'); ?>" + "?cate_id=" + cate_id;
...
<ul class="nav nav-tabs" role="tablist">
    <li><a href="<?php echo url('admin/tag/index'); ?>">标签列表</a></li>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" placeholder="标签名称" name="tagname" value="<?php echo $field['tagname']; ?>">
                </div>
            </div>
        </div>
    </div>
    <input type="hidden" name="tagid" value="<?php echo $field['tagid']; ?>">
