<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:74:"C:\Thankphp\Thinkphp\public/../application/admin\view\article\recycle.html";i:1523364529;s:63:"C:\Thankphp\Thinkphp\public/../application/admin\view\base.html";i:1523370564;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<ol class="breadcrumb" style="background-color: #f9f9f9;padding:8px 0;margin-bottom:10px;">
    ...
    <li class="active">
        <a href="<?php echo url('recycle'); ?>">回收站</a>
    </li>
</ol>
<ul class="nav nav-tabs" role="tablist">
    <li class="active"><a href="<?php echo url('recycle'); ?>">回收站</a></li>
</ul>
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><img src="<?php echo $vo['thumb']; ?>" class="img-responsive img-thumbnail" width="150" alt="" srcset=""></td>
                        <td>
                            <input type="text" onblur="changeSort(this,<?php echo $vo['articleid']; ?>,<?php echo $vo['sort']; ?>)" class="form-control" value="<?php echo $vo['sort']; ?>">
                        </td>
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    <li><a href="<?php echo url('outToRecycle',['articleid'=>$vo['articleid']]); ?>">恢复数据</a></li>
                                    <li class="divider"></li>
                                    <li><a href="javascript:void(0);" onclick="del(<?php echo $vo['articleid']; ?>)">彻底删除</a></li>
                                </ul>
                            </div>
                        </td>
                    </tr>
...
<script>
    ...
    function changeSort(obj, arc_id, sortid) {
        ...
        if (sort == sortid) {
            ...
            $.post(
                "<?php echo url('admin/Article/changeSort'); ?>", {
                    sort: sort,
                    articleid: arc_id
                },
                function(res) {
    ...
    function del(arc_id) {
        require(['hdjs'], function(hdjs) {
            hdjs.confirm('确定删除吗?', function() {
                window.location.href = "<?php echo url('admin/Article/del'); ?>" + "?arc_id=" + arc_id;
            });
        })
    }
</script>
