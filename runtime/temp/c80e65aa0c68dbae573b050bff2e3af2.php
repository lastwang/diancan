<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"C:\Thankphp\Thinkphp\public/../application/admin\view\article\store.html";i:1515660526;s:63:"C:\Thankphp\Thinkphp\public/../application/admin\view\base.html";i:1515659057;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <textarea type="text" name="abstract" class="form-control" placeholder="文章摘要"></textarea>
                </div>
            </div>
            <div class="form-group">
