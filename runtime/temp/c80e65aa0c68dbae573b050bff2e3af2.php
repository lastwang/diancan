<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"C:\Thankphp\Thinkphp\public/../application/admin\view\article\store.html";i:1523330655;s:63:"C:\Thankphp\Thinkphp\public/../application/admin\view\base.html";i:1523370564;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<ul class="nav nav-tabs" role="tablist">
    ...
    <li class="active"><a href="<?php echo url('store'); ?>">菜品添加</a></li>
</ul>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" name="title" class="form-control" placeholder="菜品标题">
                </div>
            </div>
            <div class="form-group">
                <label for="" class="col-sm-2 control-label">菜品作者</label>
                <div class="col-sm-9">
                    <input type="text" name="author" class="form-control" placeholder="菜品作者">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    ...
                    <label class="checkbox-inline">
                            <input type="checkbox" name="tag[]" value="<?php echo $vo['tagid']; ?>"> <?php echo $vo['tagname']; ?>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    ...
                    <div class="input-group" style="margin-top:5px;">
                        <img src="__STATIC__/image/nopic.jpg" class="img-responsive img-thumbnail" width="150">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <textarea type="text" name="abstract" class="form-control" placeholder="菜品摘要"></textarea>
                </div>
            </div>
            <div class="form-group">
