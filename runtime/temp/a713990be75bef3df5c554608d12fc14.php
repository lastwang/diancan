                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    <li><a href="<?php echo url('admin/tag/store',['tagid'=>$vo['tagid']]); ?>">编辑</a></li>
                                    <li class="divider"></li>
                                    <li><a href="javascript:;" onclick="del(<?php echo $vo['tagid']; ?>)">删除</a></li>
                                </ul>
                            </div>
                        </td>
                    </tr>
    ...
    function del(tag_id) {
        require(['hdjs'], function(hdjs) {
            hdjs.confirm('确定删除吗?', function() {
                window.location.href = "<?php echo url('admin/Tag/pass'); ?>" + "?tag_id=" + tag_id;
            })
        })
    }
</script>
